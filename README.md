...
## Javascript Assignments  [![Build Status](https://travis-ci.org/Sergey-Starushkin/js-assignments.svg?branch=task1-4)](https://travis-ci.org/Sergey-Starushkin/js-assignments)
...
* Run `git clone https://github.com/Sergey-Starushkin/js-assignments.git` from command line to download the repo.
...
* Edit local README.md file and update all links (just replace all occurrences of `'Sergey-Starushkin'` with your account name).
...
```
* Open https://github.com/Sergey-Starushkin/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
