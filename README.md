...
## Javascript Assignments  [![Build Status](https://travis-ci.org/Sergey-Starushkin/js-assignments.svg?branch=task7)](https://travis-ci.org/Sergey-Starushkin/js-assignments)
