...
## Javascript Assignments  [![Build Status](https://travis-ci.org/DmitryLobachevsky/js-assignments.svg?branch=master)](https://travis-ci.org/AisBrestEDU/js-assignments)
