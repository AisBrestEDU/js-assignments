...
## Javascript Assignments  [![Build Status](https://travis-ci.org/Arseni-Lamihov/js-assignments.svg?branch=master)](https://travis-ci.org/Arseni-Lamihov/js-assignments)
