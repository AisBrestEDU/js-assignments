[![VladSelikh](http://brest.rollingscopes.com/images/logo_rs_text.svg)](http://brest.rollingscopes.com/)
#VladSelikh School
...
* Edit local README.md file and update all links (just replace all occurrences of `'VladSelikh'` with your account name).
...
```
* Open https://github.com/VladSelikh/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
