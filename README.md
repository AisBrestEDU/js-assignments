[![cardtuc](https://avatars0.githubusercontent.com/u/60508453?s=460&u=265c9d60fe6f50df6fcdbc67b834f2f6ad255ddb&v=4)](https://github.com/cardtuc)
#Konyakhina Christina
## Javascript Assignments  [![Build Status](https://travis-ci.org/cardtuc/js-assignments.svg?branch=master)](https://travis-ci.org/cardtuc/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'cardtuc'` with your account name).
...
```
* Open https://github.com/cardtuc/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/cardtuc/js-assignments/builds).
