[![PopovDmitriy](http://brest.rollingscopes.com/images/logo_rs_text.svg)](https://github.com/PopovDmitriy)
...
```
* Open https://github.com/PopovDmitriy/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/PopovDmitriy/js-assignments/builds).
