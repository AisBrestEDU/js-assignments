...
function timeSpanToString(startDate, endDate) {
   ...
   let milliseconds = parseInt((delta % 1000));
...
function angleBetweenClockHands(date) {
   let UtcHours = Math.floor(date.getUTCHours());
   UtcHours = UtcHours > 12 ? UtcHours - 12 : UtcHours;
   let UtcMinutes = Math.floor(date.getUTCMinutes());
   let result = Math.abs(0.5 * (60 * UtcHours - 11 * UtcMinutes) * (Math.PI / 180));
