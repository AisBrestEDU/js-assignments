...
function timeSpanToString(startDate, endDate) {
   ...
   milliSeconds %= 1000;
   milliSeconds = (milliSeconds / 1000).toFixed(3).slice(2, 5)
...
function angleBetweenClockHands(date) {
   ...
   let hourHandAngle = 0.5 * (60 * hours + minutes);
   hourHandAngle = hours > 12 ? hourHandAngle - 360 : hourHandAngle;
   let minuteHandAngle = 6 * minutes;
   let angle = hourHandAngle - minuteHandAngle;
