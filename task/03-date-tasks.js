...
function timeSpanToString(startDate, endDate) {
    ...
    let mseconds = parseInt(duration % 1000);
    ...
    mseconds = (mseconds < 10) ? "000" : mseconds;
...
function angleBetweenClockHands(date) {
    ...
    let hours = newdate.getUTCHours() % 12;
    ...
    let angle = totalAngle > 180 ? 360 - totalAngle : totalAngle;
