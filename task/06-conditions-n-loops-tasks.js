...
function timespanToHumanString(startDate, endDate) {
    ...
    if (day > 45) {
        return Math.ceil(month - 0.5) + ' months ago';
    }
    if (day > 25) {
        return 'a month ago';
    }
    if (hour > 36) {
        return Math.ceil(day - 0.5) + ' days ago';
    }
    if (hour > 22) {
        return 'a day ago';
    }
    if (min > 90) {
        return Math.ceil(hour - 0.5) + ' hours ago';
    }
    if (min > 45) {
        return 'an hour ago';
    }
    if (sec > 90) {
        return Math.ceil(min - 0.5) + ' minutes ago';
    }
    if (sec > 45) {
        return 'a minute ago';
    }
