...
function extractNameFromTemplate(value) {
    ...
    if (value.includes(a) && value.includes(b)) {
        return value.slice(a.length, value.lastIndexOf(b))
    }
}
...
function encodeToRot13(str) {
    ...
    for (let i = 0; i < str.length; i++) {
        ...
        let indexInUppercaseAlphabet = uppercaseAlphabet.indexOf(str[i]);
        let indexInLowercaseAlphabet = lowercaseAlphabet.indexOf(str[i]);

        if (indexInUppercaseAlphabet !== -1) {
            if (indexInUppercaseAlphabet <= 12) {
                resultString += uppercaseAlphabet[indexInUppercaseAlphabet + 13]
            } else {
                resultString += uppercaseAlphabet[indexInUppercaseAlphabet - 13]
            }
        } else if (indexInLowercaseAlphabet !== -1) {
            if (indexInLowercaseAlphabet <= 12) {
                resultString += lowercaseAlphabet[indexInLowercaseAlphabet + 13]
            } else {
                resultString += lowercaseAlphabet[indexInLowercaseAlphabet - 13]
            }
        } else {
