...
function encodeToRot13(str) {
    let res = str.split('').map((sym) => {
        let char = sym.charCodeAt(0);
        if (char > 77 && char < 91) {
            sym = String.fromCharCode(char - 13);
        } else if (char > 64 && char < 78) {
            sym = String.fromCharCode(char + 13);
        } else if (char > 109 && char < 123) {
            sym = String.fromCharCode(char - 13);
        } else if (char > 96 && char < 110) {
            sym = String.fromCharCode(char + 13);
        }
        return sym;
    });
