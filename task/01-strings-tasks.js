...
function encodeToRot13(str) {
    ...
    for (let i = 0; i < str.length; i++){
        if (str.codePointAt(i) > 64 && str.codePointAt(i) < 78) result += String.fromCodePoint(str.codePointAt(i) + 13);
        else if (str.codePointAt(i) > 77 && str.codePointAt(i) < 91) result += String.fromCodePoint(str.codePointAt(i) - 13);
        else if (str.codePointAt(i) > 96 && str.codePointAt(i) < 110) result += String.fromCodePoint(str.codePointAt(i) + 13);
        else if (str.codePointAt(i) > 109 && str.codePointAt(i) < 123) result += String.fromCodePoint(str.codePointAt(i) - 13);
        else result += str[i];
    }
    return result;
}
