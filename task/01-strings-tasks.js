...
function encodeToRot13(str) {
    return str.replace(/[A-Za-z]/g, function (c) { // g - глобальное сопастовление
        return String.fromCharCode(c.charCodeAt(0) + (c.toUpperCase() <= "M" ? 13 : -13)); // charCodeAt(0) = 65 = А;
    });
}
