...
function getPolynom(...args) {
    ...
    return x => arr.reduce((sum, item, i) => sum += item * Math.pow(x, i), 0);
}
...
function partialUsingArguments(fn) {
    ...
    return function () {
        return fn.apply(this, a.concat(...arguments));
    }
