...
class CssBuilder {
    ...
    error(value) {
        ...
        if (value === this.value && [1, 2, 6].includes(value)) {
...
const cssSelectorBuilder = {
    ...
    combine: (selector1, combinator, selector2) => new CssBuilder().combine(selector1, combinator, selector2),
};
