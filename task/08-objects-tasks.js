...
class CssSelectorBuilder {
    constructor() {
        this.types= new Array(6).fill(false);
        this.follow = [];
        this.content = {
            element: undefined,
            id: undefined,
        ...
        SetCssSelectorType(type) {
        let temp = this.types.slice(type + 1);

        let isAddedSelectorType = temp.some(function (isAdded) 
        {
            return isAdded;
        });

        if (isAddedSelectorType)
        {
