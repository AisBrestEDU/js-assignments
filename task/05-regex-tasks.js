...
function getRegexForIPv4() {
   return new RegExp(/^((0\d{1,2})|(00\d)|(\d{1,2})|(1\d{1,2})|(2[0-4]\d)|(25[0-5]))(\.((0\d{1,2})|(00\d)|(\d{1,2})|(1\d{1,2})|(2[0-4]\d)|(25[0-5]))){3}$/);
}
...
function getRegexForSSN() {
   return new RegExp(/((\d{2}[1-9])|([1-9]\d{2})|(0[1-9]0))-((\d[1-9])|([1-9]\d))-((\d{3}[1-9])|([1-9]\d{3})|(00[1-9]0)|(0[1-9]00))/);
}
