...
function getRegexForSSN() {
   return /([1-9][0-9][0-9]|0[1-9][0-9]|00[1-9])\-([1-9][0-9]|0[1-9])\-([1-9][0-9][0-9][0-9]|0[1-9][0-9][0-9]|00[1-9][0-9]|000[1-9])/;
}
...
function getPasswordValidator(minLength) {
   var regStr = `^(?=.*[A-Z])(?=.*[a-z])(?=.*\\d)[a-zA-Z0-9]{${minLength},}$`;
