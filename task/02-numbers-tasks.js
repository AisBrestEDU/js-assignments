...
function getAverage(value1, value2) {
    let averageOfSum = (value1 + value2) / 2;
    if (isFinite(averageOfSum))
    {
        return averageOfSum;
    }
    if (averageOfSum === Number.NEGATIVE_INFINITY)
    {
...
function toNumber(value, def) {
    let parsingToNumber = parseFloat(value);
    return isNaN(parsingToNumber ) ? def : parsingToNumber;
}
