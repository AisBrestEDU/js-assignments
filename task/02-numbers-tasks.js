...
function getAverage(value1, value2) {
    return Math.ceil(value1 / 2 + value2 / 2);
}
...
function roundToPowerOfTen(num, pow) {
    let smallerMul = (num - num % Math.pow(10, pow)) / Math.pow(10, pow) * Math.pow(10, pow);
    let biggerMul = smallerMul + Math.pow(10, pow);
    return num - smallerMul > biggerMul - num ? biggerMul : smallerMul;
}
